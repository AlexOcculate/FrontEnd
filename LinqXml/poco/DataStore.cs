...
namespace LinqXml
{
   public partial class DataStore
   {
      ...
      public static DataStore GetPoco( System.Xml.Linq.XElement e )
      {
         ...
         {
            Boolean.TryParse( e.Attribute( "lddo" ).Value, out lddo );
         }

         bool lso = false;
         if( e.Attribute( "lso" ) != null )
         {
            Boolean.TryParse( e.Attribute( "lso" ).Value, out lso );
         }

         bool wf = false;
         if( e.Attribute( "wf" ) != null )
         {
            Boolean.TryParse( e.Attribute( "wf" ).Value, out wf );
         }
